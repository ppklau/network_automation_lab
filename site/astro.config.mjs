	...
	integrations: [
		starlight({
			...
			sidebar: [
				...
				{
					label: 'Part 7 — Workflow Orchestration',
					items: [
						{ label: 'Introducing Rundeck', slug: 'part7/20-orchestration-intro' },
						{ label: 'Approval Workflows', slug: 'part7/21-approval-workflows' },
						{ label: 'Scheduling', slug: 'part7/22-scheduling' },
						{ label: 'Orchestration as a Compliance Layer', slug: 'part7/23-orchestration-audit' },
					],
				},
				{
					label: 'Part 8 — Hardware Lifecycle & Monitoring',
					items: [
						{ label: 'Hardware Lifecycle', slug: 'part8/24-hardware-lifecycle-intro' },
						{ label: 'Leaf RMA', slug: 'part8/25-leaf-rma' },
						{ label: 'Border RMA', slug: 'part8/26-border-rma' },
						{ label: 'ZTP Branch Provisioning', slug: 'part8/27-ztp-branch' },
						{ label: 'OS Upgrade', slug: 'part8/28-os-upgrade' },
						{ label: 'Monitoring Introduction', slug: 'part8/29-monitoring-intro' },
						{ label: 'Dashboards', slug: 'part8/30-dashboards' },
						{ label: 'Alerting', slug: 'part8/31-alerting' },
					],
				},
				{
					label: 'Part 9 — Advanced Topics',
					items: [
						{ label: 'Advanced Topics', slug: 'part9/32-advanced-intro' },
						{ label: 'Auto-Remediation', slug: 'part9/33-auto-remediation' },
						{ label: 'Staged Rollout', slug: 'part9/34-staged-rollout' },
						{ label: 'Bulk Import', slug: 'part9/35-bulk-import' },
						{ label: 'Capstone', slug: 'part9/36-capstone' },
					],
				},
				{
					label: 'Appendix',
